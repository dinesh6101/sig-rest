...
public class RepositoryFromEntity {
	...
	private String REPOSITORY_LOCATION = "src/main/java/com/sig/team/webworks/matrimonial/crud/repository/";
	...
	public void exec() {
		...
		File folder = new File("src/main/java/com/sig/team/webworks/matrimonial/crud/entity");
